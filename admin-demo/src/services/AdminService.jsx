...
export const forgotPassword = async (email) => {
    return await APIManager.postRequest({
        path: API_ENDPOINT.FORGOT_PASSWORD_API,
        data: { email }
    });
};
...
export const resetPassword = async (resetToken, newPassword) => {
    return await APIManager.postRequest({
        path: API_ENDPOINT.RESET_PASSWORD_API,
...
export const restoreProduct = async (id) => {
    return await APIManager.putRequest({
        path: API_ENDPOINT.RESTORE_PRODUCT(id),
        token: true
    })
}
...
export const bulkRestoreProducts = async (ids) => {
    return await APIManager.putRequest({
        path: API_ENDPOINT.BULK_RESTORE,
        data: { ids },
        token: true
    })
}
...
export const changeMyPassword = async (currentPassword, newPassword) => {
    return await APIManager.putRequest({
        path: API_ENDPOINT.CHANGE_PASSWORD_API,
