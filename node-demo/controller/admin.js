...
exports.getProducts = catchAsync(async (req, res) => {
    const baseQuery = "SELECT * FROM products WHERE is_soft_deleted = FALSE";
...
exports.getAllReviews = catchAsync(async (req, res) => {
    ...
    // Frontend uses: product_title, full_name, rating, comment
    // Note: product_title is an alias for p.title, not a real column
    const searchableColumns = ['r.rating', 'r.comment', 'u.full_name', 'p.title'];
    
    // Add custom column mapping for aliased columns
    const columnMapping = {
