                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">{settings?.contact_email || 'support@grocerystore.com'}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-6">
                                    <div className="bg-indigo-100 p-4 rounded-2xl">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">{settings?.address || '123 Main Street, City, Country 12345'}</p>
                                    </div>
                                </div>
                            </div>
